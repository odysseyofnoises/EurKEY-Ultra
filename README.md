...
* Limited use cases. Most people don't need to type this many different languages on the same layout and will usually just stick to their local keyboard layout or switch between a few layouts. I made EurKEY Ultra as a fun little experiment and side-project. It's mostly a novelty. I can't guarantee it has any practical uses. 
* This keyboard layout isn't for everyone. Some people won't like the placement of the keys, for example. Some people won't like using dead keys to type accents. A keyboard is a tool, so you should use whatever system works best for you
