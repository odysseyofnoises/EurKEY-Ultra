...
* The keyboard layout is designed with US QWERTY keycaps in mind. All of the accents are typed using the number keys, which are the same on most keyboards, but if you're not using a US QWERTY layout, keep in mind that other letters and symbols won't visually make sense to what's printed on your keycaps
