...
* Limited use cases. Most people don't need to type this many different languages on the same layout and will usually just stick to their local keyboard layout or switch between a few layouts. EurKEY Ultra was made for fun as an experiment. It's mostly just a novelty. I can't guarantee it has any practical uses
