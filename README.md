...
* Added variants of several Greek symbols ϵ, ϱ, ϖ, ϕ, and ϑ, as well as Hebrew ℵ, which are used in math. To type them, hold the AltGr key while typing the base Greek symbol in the math layer. For example, AltGr + m + e → ϵ (or AltGr + m, AltGr + e)
