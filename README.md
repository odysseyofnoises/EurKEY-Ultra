...
* The Greek symbols can be used for math, but they are from the language block in Unicode, not the Mathematical Alphanumeric Symbols block. It's not possible to add symbols outside of Unicode's Basic Multilingual Plane to Windows keyboard layouts. Keep this in mind if that matters for your situation
